    ...
    return (
        <>
                ...
                <div className="main-container">
                    <div className="about-main-section-content">
                        <div className="about-main-section-info-container">
                            <h5 className="section-subtitle">{dictionary.about_overall}</h5>
                            <h3>{dictionary.about_who}</h3>
                            <p className="mid-section-paragraph">
                                {dictionary.about_who_description}
                            </p>
                        </div>
                        <Value
            ...
            <Mission
                ...
                title={dictionary.about_mission}
                description={dictionary.about_mission_description}
            />
            <Cta title={dictionary.about_click} buttonText={dictionary.about_touch}/>
            <Footer/>
        </>
    );
};
